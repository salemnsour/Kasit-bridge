...
if(isset($_POST["message"])){
    ...
    $sql = $conn->prepare("INSERT INTO general_chat (userID,message) VALUES (?,?)");
    $sql->bind_param("ss",$_SESSION["userID"],$escaped_message);
    $sql->execute();
    ...
    <script>
        $(document).ready(function() {
            function updateContent() {
                $('#live-chat').load('general_chat2.php');
...
<header class="header">
    ...
    <div class="chat-container">
        ...
        <form action="general_chat.php" method="post">
